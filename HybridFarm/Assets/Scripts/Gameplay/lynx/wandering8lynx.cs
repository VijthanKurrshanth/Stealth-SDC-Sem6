...
public class wandering8lynx : MonoBehaviour
{
    ...
    void FindMovingAngleAndDirectionAndAnimate() 
    {
        ...
        {
            SetAnimeFalse();
            anim.SetBool("lynx_left_anim",true);
        ...
        {
            SetAnimeFalse();
            anim.SetBool("lynx_leftup_anim",true);
            sprite_render.flipX=true;
        ...
        {
            SetAnimeFalse();
            anim.SetBool("lynx_up_anim",true);
        ...
        {
            SetAnimeFalse();
            anim.SetBool("lynx_leftdown_anim",true);
            sprite_render.flipX=false;
        ...
        {
            SetAnimeFalse();
            anim.SetBool("lynx_down_anim",true);
            sprite_render.flipX=false;
    ...
    void SetAnimeFalse()
    {
        anim.SetBool("lynx_up_anim",false);
        anim.SetBool("lynx_leftup_anim",false);
        anim.SetBool("lynx_left_anim",false);
        anim.SetBool("lynx_leftdown_anim",false);
        anim.SetBool("lynx_down_anim",false);
