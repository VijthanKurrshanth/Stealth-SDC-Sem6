...
public class wandering8chicken : MonoBehaviour
{
    ...
    void FindMovingAngleAndDirectionAndAnimate() 
    {
        ...
        {
            SetAnimeFalse();
            anim.SetBool("chicken_left_anim",true);
        ...
        {
            SetAnimeFalse();
            anim.SetBool("chicken_leftup_anim",true);
            sprite_render.flipX=true;
        ...
        {
            SetAnimeFalse();
            anim.SetBool("chicken_up_anim",true);
        ...
        {
            SetAnimeFalse();
            anim.SetBool("chicken_leftdown_anim",true);
            sprite_render.flipX=false;
        ...
        {
            SetAnimeFalse();
            anim.SetBool("chicken_down_anim",true);
            sprite_render.flipX=false;
    ...
    void SetAnimeFalse()
    {
        anim.SetBool("chicken_up_anim",false);
        anim.SetBool("chicken_leftup_anim",false);
        anim.SetBool("chicken_left_anim",false);
        anim.SetBool("chicken_leftdown_anim",false);
        anim.SetBool("chicken_down_anim",false);
